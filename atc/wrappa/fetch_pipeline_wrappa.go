...
func (f fetchPipelineHandler) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	if pipelineID != "" {
		...
		pipeline, statusCode = f.fetchPipelineByName(teamName, pipelineName)
	}
...
func (f fetchPipelineHandler) fetchPipelineByName(teamName, pipelineName string) (db.Pipeline, statusCode) {
